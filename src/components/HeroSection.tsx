                ...
                <div className="flex gap-6 pt-2">
                  ...
                  >
                    <svg
                      ...
                      aria-hidden="true"
                    >
                      <path d="M12 1C5.925 1 1 5.925 1 12c0 2.695.94 5.17 2.5 7.1L2 22l3.1-1.4A10.94 10.94 0 0 0 12 23c6.075 0 11-4.925 11-11S18.075 1 12 1zm-3.5 9.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1 0-1zm0 3h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1 0-1z" />
                    </svg>
                  </a>
                </div>
              </div>
